...
from api.models import Villa, UserProfile, Booking, ContactMessage, Review, Wishlist
from api.serializers import VillaSerializer, UserProfileSerializer, BookingSerializer, RegisterSerializer, ContactMessageSerializer, ReviewSerializer, WishlistSerializer
